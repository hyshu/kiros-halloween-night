...
class _StringsCandyTypesCookieEn {
	...
	String get description => 'A crispy cookie that increases movement speed for 30 turns';
}
...
class _StringsCandyTypesLollipopEn {
	...
	String get description => 'A colorful lollipop that increases luck for 25 turns';
}
...
class _StringsCandyTypesCookieJa extends _StringsCandyTypesCookieEn {
	...
	@override String get description => '30ターンの間移動速度を上げるサクサククッキー';
}
...
class _StringsCandyTypesLollipopJa extends _StringsCandyTypesLollipopEn {
	...
	@override String get description => '25ターンの間運を上げるカラフルなロリポップ';
}
...
extension on Strings {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'candyCollection.messages.4': return 'Kiro gobbles up the {name}, feeling more spirited than ever!';
			...
			case 'candyTypes.cookie.description': return 'A crispy cookie that increases movement speed for 30 turns';
			...
			case 'candyTypes.lollipop.description': return 'A colorful lollipop that increases luck for 25 turns';
...
extension on _StringsJa {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'candyCollection.messages.4': return 'キロが{name}をむしゃむしゃ食べて、これまで以上に元気になりました！';
			...
			case 'candyTypes.cookie.description': return '30ターンの間移動速度を上げるサクサククッキー';
			...
			case 'candyTypes.lollipop.description': return '25ターンの間運を上げるカラフルなロリポップ';
