...
import '../../lib/core/ability_manager.dart';
...
void main() {
  group('AbilityManager', () {
    ...
    test('should apply max health increase effect', () {
      ...
      expect(abilityManager.getEffectiveMaxHealth(), 
    ...
    test('should handle multiple temporary effects of same type', () {
      ...
      expect(abilityManager.getEffectiveSpeed(), equals(4.0)); // 1.0 * (1 + 1.5 + 1.5)
    });
    ...
    test('should cache effective stats for performance', () {
      ...
      expect(identical(stats1, stats2), isFalse); // Returns copy, not same object
