...
void main() {
  ...
  group('CandyCollectionSystem', () {
    ...
    test('should add candy items', () {
      final candy1 = CandyItem.create(
        CandyType.candyBar,
        'candy_1',
        position: Position(10, 10),
      );
      final candy2 = CandyItem.create(
        CandyType.chocolate,
        'candy_2',
    ...
    test('should attempt collection with full inventory', () {
      ...
      expect(
        tileMap.getTileAt(Position(5, 5)),
        equals(TileType.candy),
      ); // Tile unchanged
    });
    ...
    test('should get candy by effect', () {
      final healthCandy1 = CandyItem.create(
        CandyType.candyBar,
        'candy_1',
        position: Position(10, 10),
      );
      final healthCandy2 = CandyItem.create(
        CandyType.donut,
        'candy_2',
        position: Position(11, 11),
      );
      final speedCandy = CandyItem.create(
        CandyType.cookie,
        'candy_3',
        position: Position(12, 12),
      );
      ...
      final healthCandies = collectionSystem.getCandyByEffect(
        CandyEffect.healthBoost,
      );
      expect(healthCandies.length, equals(2));

      final speedCandies = collectionSystem.getCandyByEffect(
    ...
    test('should get candy near position', () {
      ...
      final nearCandy = collectionSystem.getCandyNearPosition(
        Position(11, 11),
        3,
      );
      expect(
        nearCandy.length,
        equals(2),
      ); // candy1 and candy2 are within distance 3
    ...
    test('should limit recent events', () {
      ...
      for (int i = 0; i < 5; i++) {
        final position = Position(
          10 + i,
          10 + i,
        ); // Use positions away from perimeter
        final candy = CandyItem.create(
          CandyType.candyBar,
          'candy_$i',
          position: position,
