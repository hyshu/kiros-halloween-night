...
import 'package:kiro_halloween_game/core/combat_detection_system.dart';
  ...
  group('CombatDetectionSystem', () {
    ...
    group('Combat Detection', () {
      test('should detect direct combat encounters', () {
        ...
        expect(
          encounters.first.encounterType,
          equals(CombatEncounterType.direct),
        );
    ...
    group('Enemy Finding', () {
      ...
      test('should find enemies in range', () {
        ...
        final enemiesInRange = detectionSystem.findEnemiesInRange(ally, [
          enemy1,
          enemy2,
        ], 3);
    ...
    group('Combat Prediction', () {
      test('should predict immediate combat engagement', () {
        ...
        final willEngage = detectionSystem.predictCombatEngagement(
          ally,
          hostileEnemy,
          1,
        );
