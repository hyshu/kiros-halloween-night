...
void main() {
  group('GhostCharacter', () {
    ...
    test('should initialize with correct properties', () {
      ...
      expect(ghostCharacter.modelPath, equals('assets/graveyard/character-ghost.obj'));
    ...
    test('should handle arrow key input correctly', () {
      ...
      final result = ghostCharacter.handleInput(LogicalKeyboardKey.arrowDown, tileMap);
    ...
    test('should handle WASD key input correctly', () {
      ...
      final result = ghostCharacter.handleInput(LogicalKeyboardKey.keyA, tileMap);
      expect(result, isTrue);
    ...
    test('should prevent movement through walls', () {
      ...
      final result = ghostCharacter.handleInput(LogicalKeyboardKey.arrowUp, tileMap);
      expect(result, isTrue); // Input was handled
      expect(ghostCharacter.position, equals(const Position(5, 5))); // But position didn't change
      expect(ghostCharacter.isIdle, isTrue); // Character should be idle after failed move
    });
    ...
    test('should prevent movement through obstacles', () {
      ...
      final result = ghostCharacter.handleInput(LogicalKeyboardKey.arrowLeft, tileMap);
      expect(result, isTrue); // Input was handled
      expect(ghostCharacter.position, equals(const Position(5, 5))); // But position didn't change
      expect(ghostCharacter.isIdle, isTrue);
    });
    ...
    test('should prevent movement outside bounds', () {
      ...
      final result = ghostCharacter.handleInput(LogicalKeyboardKey.arrowLeft, tileMap);
      expect(result, isTrue); // Input was handled
      expect(ghostCharacter.position, equals(const Position(1, 1))); // Position unchanged
      expect(ghostCharacter.isIdle, isTrue);
    });
    ...
    test('should ignore unhandled keys', () {
      final result = ghostCharacter.handleInput(LogicalKeyboardKey.space, tileMap);
      expect(result, isFalse);
      expect(ghostCharacter.position, equals(const Position(5, 5))); // No movement
    });
