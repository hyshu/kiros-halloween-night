...
void main() {
  group('Core Architecture Tests', () {
    ...
    test('GameState should manage characters correctly', () {
      ...
      final charactersAtOrigin = gameState.getCharactersAt(const Position(0, 0));
    ...
    test('GameManager should handle basic game operations', () {
      ...
      expect(gameManager.gameState.currentPhase, equals(GamePhase.initializing));
      ...
      expect(gameManager.getTileTypeAt(const Position(0, 0)), equals(TileType.floor));
